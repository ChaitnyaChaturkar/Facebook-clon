...
<body>
    ...
    <div style="position:absolute; left:7%; top:24%; color:#3B5998; font-size:28px;"> <font face="myFbFont"> Social Network helps you connect and share with </font> </div>
...
<div style="position:absolute;left:60.28%; top:74.8%; font-size:16px; color:#000000">  Birthday:  </div>
 ...
 <!--my_details -->  
    <div style="display:none;" id="my_details11">
    ...
    <div style="position:absolute;left:13%;top:75%; z-index:3;"> <img src= height="165" width="150" style="box-shadow:0px 0px 10px 5px rgb(0,0,0);"> </div>
